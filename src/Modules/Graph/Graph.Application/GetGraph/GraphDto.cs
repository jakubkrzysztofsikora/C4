...
public sealed record GraphNodeDto(Guid Id, string Name, string ExternalResourceId, string Level, string Health, double HealthScore, Guid? ParentNodeId, bool Drift = false, string Environment = "unknown", string ServiceType = "external", string ResourceGroup = "");
