...
{
    Task StoreAsync(Guid projectId, string appId, string instrumentationKey, string apiKey, CancellationToken cancellationToken);
...
public sealed record AppInsightsConfig(Guid ProjectId, string AppId, string InstrumentationKey, string ApiKey = "");
